...
public class GetProduct extends BaseTest {
    ...
    public void getPrice(){
        ...
        WebElement MacPrice = explicitWait.get().until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h3[@class='price-container']")));

        Assert.assertTrue(MacPrice.getText().contains("$700"),"Price dosen't match");
    }
    @Test
